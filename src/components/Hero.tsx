    ...
    <div className="w-full flex flex-col">
        <div className="w-full min-h-screen flex items-center px-4 py-8 gap-7 box-border">
          ...
          <div className="w-[33%] h-full flex flex-col justify-between">
            ...
            {/* Center Box */}
            <div className="w-full px-6 py-6 rounded-lg text-center mb-4 flex flex-col items-center justify-center gap-6">
              ...
              <Button
                size="lg"
                  className="bg-blue-600 hover:bg-gray-500 text-white font-semibold py-6 px-8 text-sm rounded-md  shadow-[0px_20px_35px_rgba(0,0,0,0.3)]"
              >
                Browse All Brands
              </Button>
            </div>

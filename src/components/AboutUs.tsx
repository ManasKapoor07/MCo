      ...
      <div className="max-w-7xl px-20 md:px-24">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 text-center gap-8 md:divide-x">
          {stats.map((stat, index) => (
            <div key={index} className=" grid grid-cols-1 md:grid-cols-[auto_1fr] items-center gap-4">
              <div>
              <h3 className="text-3xl font-bold text-gray-900 font-[Poppins]">{stat.number}</h3>
              <p className="text-gray-700 mt-2 text-[16px] font-medium leading-[29px] tracking-[-0.2px] font-poppins">
                {stat.label}
              </p>
            </div>
              {stat.line && <div className="hidden md:block border-l border-gray-700 h-full ml-12 mr-2"></div>}
            </div>
              ...
              <div className="max-w-5xl ">
                ...
                <p className="font-[Poppins] text-gray-600 max-w-3xl">
                  We are committed to redefining modern living by offering superior-quality sanitaryware that blends design, durability, and innovation. <br /><br/>
            ...
            <div key={index} className="flex flex-col items-start gap-4">
              ...
              <div>
                ...
                <p className="font-[Poppins] text-sm text-gray-600 text-justify">{item.desc}</p>
              </div>
            </div>
                  ))}
                </div>

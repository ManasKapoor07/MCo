  ...
  return (
    <div>
      <section className="bg-[#F5F8FF] py-20 px-4 md:px-20 text-left">
        <div className="  text-[16px] leading-[100%] tracking-[1.63px] uppercase text-[#1447E6] font-bold mb-2 uppercase ">
          About Us
        </div>

        <h2 className="  text-[35px] leading-[110%] tracking-normal font-bold text-gray-900 mb-12">
        ...
        <div className="grid md:grid-cols-[1fr_1.4fr] items-start gap-18">
          ...
          <div className="space-y-6">
            ...
            <p className="  text-[14px] leading-[26px] tracking-[-0.2px] text-justify text-gray-700 mb-2">
        ...
        <div className="mt-12 ">
          <p className="  text-[14px] leading-[26px] tracking-[-0.2px] text-justify text-gray-700">
